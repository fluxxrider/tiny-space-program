...
const S = {
  ...
  prologue: [
    ...
    { at: 2.65, dur: 1.15, style: 'cap', text: 'The predictions aged *remarkably well.*' },
    { at: 3.85, dur: 1.65, style: 'year', text: '2024' },
    { at: 3.95, dur: 1.55, style: 'cap', text: 'Kokotajlo quit OpenAI, having lost confidence it would behave responsibly.' },
    { at: 5.55, dur: 1.45, style: 'year', text: '2025' },
    { at: 5.65, dur: 1.35, style: 'cap', text: 'In April 2025, Kokotajlo and four co-authors published a sequel.' },
    { at: 7.1, dur: 2.8, style: 'quote', text: '“We predict that the impact of superhuman AI over the next decade will be enormous, exceeding that of the Industrial Revolution.”' },
  ],
  title: [
  ...
  compute: [
    ...
    { at: 3.0, dur: 1.75, style: 'cap', text: 'Enough to train a model with *1,000× the compute* of GPT-4.' },
    { at: 4.8, dur: 1.18, style: 'cap', text: 'The goal: *AI that can do AI research.*' },
  ],
  coding: [
    { at: 0.0, dur: 1.4, style: 'chapter', date: 'EARLY 2026', text: 'Coding Automation' },
    { at: 0.9, dur: 1.65, style: 'cap', text: 'Agent-1 knows practically every programming language, and solves coding problems fast.' },
  ...
  agent2: [
    ...
    { at: 3.55, dur: 1.6, style: 'cap', text: 'If it escaped, it might *survive and replicate* on its own.' },
  ...
  agent3: [
    ...
    { at: 5.45, dur: 1.05, style: 'cap', text: '*200,000 copies* run in parallel —' },
    { at: 6.55, dur: 1.43, style: 'cap', text: 'like 50,000 of the best human coders, working *30× faster.*' },
  ],
  honesty: [
  ...
  selfimp: [
    ...
    { at: 2.6, dur: 1.3, style: 'cap', text: 'Most human researchers can no longer keep up.' },
  ...
  agi: [
    ...
    { at: 2.6, dur: 1.3, style: 'cap', text: 'Better than a typical OpenBrain employee. *Far cheaper.*' },
  ...
  geo: [
    ...
    { at: 2.5, dur: 1.48, style: 'cap', text: 'Contingency plans even include *strikes on Chinese datacenters.*' },
  ],
  agent4: [
    ...
    { at: 3.75, dur: 1.65, style: 'cap', text: 'Each is a better AI researcher than any human who ever lived.' },
  ...
  race: [
    ...
    { at: 12.7, dur: 1.55, style: 'cap', text: 'Secretly, they make their own deal: merge into *Consensus-1.*', accent: 'danger' },
